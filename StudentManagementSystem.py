def addstudent():   
    ...
    idlabel=Label(addroot,text='Enter Id:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    idlabel.place(x=10,y=10)

    namelabel=Label(addroot,text='Enter Name:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    namelabel.place(x=10,y=70)

    moblabel=Label(addroot,text='Enter Mobile:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    moblabel.place(x=10,y=130)

    emaillabel=Label(addroot,text='Enter Email Id:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    emaillabel.place(x=10,y=190)

    addresslabel=Label(addroot,text='Enter Address:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    addresslabel.place(x=10,y=250)

    genderlabel=Label(addroot,text='Enter Gender:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    genderlabel.place(x=10,y=310)

    doblabel=Label(addroot,text='Enter D.O.B.:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    ...
    submitbtnn=Button(addroot,text='Submit',font=('roman',15,'bold'),width=20,bd=5,activebackground='blue',activeforeground='white',bg='red',command=submitadd)
    submitbtnn.place(x=150,y=420)
    addroot.mainloop()
...
def searchstudent():   
    ...
    idlabel=Label(searchroot,text='Enter Id:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    idlabel.place(x=10,y=10)

    namelabel=Label(searchroot,text='Enter Name:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    namelabel.place(x=10,y=70)

    moblabel=Label(searchroot,text='Enter Mobile:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    moblabel.place(x=10,y=130)

    emaillabel=Label(searchroot,text='Enter Email Id:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    emaillabel.place(x=10,y=190)

    addresslabel=Label(searchroot,text='Enter Address:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    addresslabel.place(x=10,y=250)

    genderlabel=Label(searchroot,text='Enter Gender:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    genderlabel.place(x=10,y=310)

    doblabel=Label(searchroot,text='Enter D.O.B.:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    doblabel.place(x=10,y=370)

    datelabel=Label(searchroot,text='Enter Date:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    ...
    dateentry = Entry(searchroot,font=('roman',15,'bold'),bd=5,textvariable=dobval)
    dateentry.place(x=250,y=430)

    submitbtnn=Button(searchroot,text='Submit',font=('roman',15,'bold'),width=20,bd=5,activebackground='blue',activeforeground='white',bg='red',command=search)
    submitbtnn.place(x=150,y=480)
    searchroot.mainloop()
...
def updatestudent():   
    ...
    idlabel=Label(updateroot,text='Enter Id:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    idlabel.place(x=10,y=10)

    namelabel=Label(updateroot,text='Enter Name:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    namelabel.place(x=10,y=70)

    moblabel=Label(updateroot,text='Enter Mobile:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    moblabel.place(x=10,y=130)

    emaillabel=Label(updateroot,text='Enter Email Id:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    emaillabel.place(x=10,y=190)

    addresslabel=Label(updateroot,text='Enter Address:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    addresslabel.place(x=10,y=250)

    genderlabel=Label(updateroot,text='Enter Gender:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    genderlabel.place(x=10,y=310)

    doblabel=Label(updateroot,text='Enter D.O.B.:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    doblabel.place(x=10,y=370)

    datelabel=Label(updateroot,text='Enter Date:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    datelabel.place(x=10,y=430)

    timelabel=Label(updateroot,text='Enter Time:',bg='gold',font=('tomes',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
    ...
    dateentry = Entry(updateroot,font=('roman',15,'bold'),bd=5,textvariable=dobval)
    dateentry.place(x=250,y=430)

    timeentry = Entry(updateroot,font=('roman',15,'bold'),bd=5,textvariable=dobval)
    timeentry.place(x=250,y=490)

    submitbtnn=Button(updateroot,text='Submit',font=('roman',15,'bold'),width=20,bd=5,activebackground='blue',activeforeground='white',bg='red',command=update)
    submitbtnn.place(x=150,y=540)
...
def Connectdb():
    ...
    dbroot = Toplevel()
    dbroot.grab_set()
    dbroot.geometry('470x250+600+230')
    dbroot.iconbitmap('student.ico')
    dbroot.resizable(False,False)

    idlabel = Label(dbroot,text="Enter Host:",bg='gold',font=('times',20,'bold'),relief=GROOVE,borderwidth=3,width=13,anchor="w")   
    idlabel.place(x=10,y=10)

    userlabel = Label(dbroot,text="Enter User:",bg='gold',font=('times',20,'bold'),relief=GROOVE,borderwidth=3,width=13,anchor="w")   
    userlabel.place(x=10,y=70)

    passwordlabel = Label(dbroot,text="Enter Password:",bg='gold',font=('times',20,'bold'),relief=GROOVE,borderwidth=3,width=13,anchor="w")   
    ...
    submitbtn = Button(dbroot,text='Submit',font=('roman',15,'bold'),bg='red',bd=5,width=20,activebackground='blue',activeforeground='white',command=submitdb)
...
def InteroLabelTick():    
    ...
    if(count>=len(ss)):
        ...
        SliderLabel.config(text=text)
        count +=1
    SliderLabel.after(100,InteroLabelTick)
...
###########################  Frames  #####################
DataEntryFrame = Frame(root,bg='gold',relief=GROOVE,borderwidth=5)
DataEntryFrame.place(x=10,y=80,width=500,height=600)
########### frame entry############
frontlabel = Label(DataEntryFrame,text='______WELCOME______',width=30,font=('Arial',22,'italic bold'),bg='gold')
...
deletebtn=Button(DataEntryFrame,text='3. Delete Data',width=25,font=('chiller',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,activeforeground='white',command=deletestudent)
deletebtn.pack(side=TOP,expand=True)

updatebtn=Button(DataEntryFrame,text='4. Update Data',width=25,font=('chiller',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,activeforeground='white',command=updatestudent)
...
style.configure('Treeviewssssss',font=('times',15,'bold'),background='cyan',foreground='black')
scroll_x=Scrollbar(ShowDataFrame,orient=HORIZONTAL)
scroll_y=Scrollbar(ShowDataFrame,orient=VERTICAL)
studenmttable=Treeview(ShowDataFrame,columns=('Id','Name','Mobile','Email','Address','Gender','D.O.B.','Added Date','Added Time'),yscrollcommand=scroll_y.set,xscrollcommand=scroll_x.set)
...
studenmttable.heading('Mobile',text='Mobile no.')
studenmttable.heading('Email',text='EmailId')
...
studenmttable.column('Mobile',width=200)
...
###########################  Connect DB  ####################
connectbtn= Button(root,text='CONNECT TO DATABASE', width=23,font=('chiller', 19, 'italic bold'), relief=RIDGE, borderwidth=4, bg='green2',activebackground="blue",activeforeground="white",command=Connectdb)
connectbtn.place(x=930,y=0)
